...
const cms = useComponentCMS('OceanSafariView')
const tripData = useTripData('ocean-safari')
...
const fallbackItinerary: ItineraryItem[] = [
  {
    ...
    description: 'Board Ocean Safari at Exmouth Marina. Brief safety orientation, then set sail for our first anchorage on the northern reef. Afternoon snorkel and sunset dinner on deck.',
    imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=1200&q=80',
  },
  {
    day: 'Day 2',
    title: 'Northern Reef & Snorkel',
    description: 'Wake up anchored on the reef. Full day exploring the pristine northern reaches — multiple snorkel sessions over untouched coral gardens teeming with marine life.',
  ...
  },
  {
    ...
    description: 'The highlight of the expedition. Our spotter plane locates whale sharks and we enter the water for multiple swims alongside these gentle giants. You will be changed forever.',
  ...
  },
  {
    ...
    description: 'A full day at Turquoise Bay — Ningaloo\'s most iconic snorkel site. Drift over spectacular coral formations. Look out for sea turtles, reef sharks, and rays in the shallows.',
    imageUrl: 'https://images.unsplash.com/photo-1437622368342-7a3d73a34c8f?auto=format&fit=crop&w=1200&q=80',
  },
  {
    day: 'Day 5',
    title: 'Yoga, Sailing & Exploration',
    description: 'Morning yoga on deck as we sail to a remote anchorage. Afternoon kayaking along the reef edge, breathwork session at sunset, and a special chef\'s dinner under the stars.',
  ...
  },
  {
    ...
    description: 'One last sunrise swim on the reef before heading back to Exmouth. Farewell brunch on deck, certificates, and a lifetime of extraordinary memories.',
    ...
    <section class="relative h-[85vh] md:h-screen w-full overflow-hidden">
      ...
      <div class="relative z-10 h-full flex flex-col justify-center items-center text-center px-4">
        ...
        <div class="flex gap-3 md:gap-4">
          <router-link to="/book/ocean-safari" class="btn-primary px-6 py-3 md:px-8 md:py-4 text-sm md:text-base">
            Check Availability
          </router-link>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 lg:gap-16 items-start">
          <div class="section-reveal-left order-2 lg:order-1">
            ...
            <p class="text-sm md:text-base leading-relaxed mb-3 md:mb-5 opacity-80" style="font-family: var(--font-body); color: var(--color-sand-200); line-height: 1.9;">
              The Ocean Safari expedition is designed for those who want the complete Ningaloo live-aboard experience without committing to a week at sea. Six carefully curated days, maximum 12 guests, and all the luxury you deserve.
            </p>
            ...
            <div class="grid grid-cols-3 gap-2 md:gap-6 mb-4 md:mb-8 pt-3 md:pt-6" style="border-top: 1px solid rgba(201, 168, 76, 0.15);">
              <div class="text-center">
                <p class="font-display text-xl md:text-3xl font-light" style="font-family: var(--font-display); color: var(--color-gold-400);">{{ tripData.durationDays.value || 6 }}</p>
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 mt-1">
              <router-link to="/book/ocean-safari" class="btn-primary inline-block text-sm md:text-base px-5 py-3 md:px-8 md:py-4">
                Reserve Your Cabin
              </router-link>
    ...
    <section class="py-12 md:py-24 lg:py-32" style="background: var(--color-ocean-950);">
      <div class="container mx-auto px-4 sm:px-6 lg:px-12 max-w-6xl">
        ...
        <div class="text-center mt-12 md:mt-20 pt-8 md:pt-12 border-t border-[#C9A84C]/20 section-reveal">
          ...
          <router-link to="/book/ocean-safari" class="btn-primary px-8 py-3 md:px-12 md:py-4 text-sm md:text-base">
            Book Expedition
          </router-link>
        </div>
      </div>
