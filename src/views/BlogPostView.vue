...
const cms = useComponentCMS('BlogPostView')
...
const fallbackItinerary: ItineraryItem[] = [
  {
    ...
    description: 'Board the M.Y. Dive Expedition at Exmouth Marina. Welcome champagne, safety briefing, and departure. First sunset dinner on the upper deck as we sail north.',
...
useSEO({
  title: 'Dive Expedition – 9-Day Ultimate Live-Aboard',
  description: 'Dive Expedition: The ultimate 9-day Ningaloo Reef expedition. Our flagship vessel with luxury suites, all-inclusive dining, and comprehensive marine encounters including whale sharks and manta rays.',
    ...
    <section class="relative h-[85vh] md:h-screen w-full overflow-hidden">
      ...
      <div class="relative z-10 h-full flex flex-col justify-center items-center text-center px-4">
        ...
        <p class="max-w-2xl text-sm md:text-lg text-white/90 mb-6 md:mb-8 font-light leading-relaxed px-2">
          Our flagship week-long expedition aboard the M.Y. Dive Expedition. Seven days, six nights, and the most comprehensive Ningaloo Reef experience available.
        </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 lg:gap-16 items-start">
          <div class="section-reveal-left order-2 lg:order-1">
            ...
            <p class="text-sm md:text-base leading-relaxed mb-3 md:mb-5 opacity-80" style="font-family: var(--font-body); color: var(--color-sand-200); line-height: 1.9;">
              The Dive Expedition is our most ambitious expedition — seven days that will transform how you see the ocean. With luxury suites, world-class dining, and an itinerary designed by marine biologists, this is the ultimate Ningaloo experience.
            </p>
