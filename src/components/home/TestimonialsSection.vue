...
const testimonials = [
  ...
  {
    quote: 'From the moment we boarded Dive Expedition, we knew this would be special. Seven days felt like both a lifetime and not nearly enough. We\'re already planning our return.',
    name: 'Dr. Rachel K.',
    location: 'Sydney, NSW',
